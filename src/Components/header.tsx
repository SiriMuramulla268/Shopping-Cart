            ...
            <nav className="navbar navbar-light nav">
                ...
                <form className="d-flex">
                    ...
                    <div className='lock'>
                        ...
                        <LoginModal isModalVisible={isModalVisible} onBackDropClick={toggleModal} header="YourCart :)" message="Login" user={props.user.user}/>
                    </div>
                    </StyledButton> 
                    ...
                    <div className='login'>
                        ...
                        <span className='user'>Hi! {props.user.userName}</span>
